 ...
 * @version $Id: left_main.php 14800 2019-01-08 04:27:15Z pdontthink $
...
function create_collapse_link($boxnum) {
    ...
    $link = '<a class="text-white" target="left" style="text-decoration:none" ' .
            'href="left_main.php?';
...
echo "\n\n" . html_tag( 'table', '', 'left', '', 'border="0" cellspacing="0" cellpadding="0" width="99%"' ) .
    ...
    html_tag( 'tr' ) .
    html_tag( 'td', '', 'center' ) .
    '<font size="4"><b class="text-center" >'. _("MPVH") . "</b><br /></font>\n\n";
...
echo '<small style="white-space: nowrap;">(<a class="text-white text-center" href="../src/left_main.php" target="left">'.
